...
namespace UnityEngine.XR.ARFoundation.Samples
{
    public class DisplayARSessionInformation : MonoBehaviour
    {
        ...
        [SerializeField]
        ARPlaneObserver m_PlaneObserver;
        ...
        void BuildPlaneMangerInfo(StringBuilder stringBuilder)
        {
            ...
            else
            {
                ...
                stringBuilder.AppendLine("Tracked planes: ");
                foreach (var plane in m_PlaneObserver.ARPlanes)
                {
                    stringBuilder.AppendLine($"{GetPlaneInfo(plane)}\n");
                }
            }
        }

        public string GetPlaneInfo(ARPlane plane)
        {
            return $"plane.trackableId: {plane.trackableId}\n plane.extents: {plane.extents}\n plane.classification: {plane.classification}\n plane.trackingState: {plane.trackingState}\n plane.alignment:  {plane.alignment}";
        }
